...
const Hero = () => {
  ...
  return (
    <div>
      <div className='bg-gradient-to-r from-[#4F0487] to-[#130121] md:mx-14 mt-8 rounded-md p-2 py-10'>
        <div className=''>
        ...
        <div className='md:flex justify-between mx-auto p-2 md:p-1 items-center bg-white text-black mt-4 gap-1 rounded md:w-1/2 ' >
          ...
          <div className='flex gap-2 m-2'>
            ...
            <input type="text" placeholder='location' ref={locationref} className='' />
          </div>
          <button onClick={onSearch} className='bg-blue-600 rounded ml-[2rem] md:ml-0 items-center text-white px-2'>Search</button>
        </div>
      </div>
      <div className='flex justify-start gap-10 items-center shadow-md border p-4 flex-wrap md:mx-14 mt-8'>
